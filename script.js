...
const TRANSLATIONS = {
  en: {
    ...
    "projects.eyebrow":"FEATURED PROJECTS","projects.heading":"Completed Projects","projects.lead":"Production-style data engineering projects with real pipeline, reliability, CI, test, and repository evidence.","projects.viewAll":"View All Projects","projects.viewProject":"View Project","projects.privateRepo":"Private Repo • Verified Evidence","projects.fullHeading":"Engineering solutions to real data challenges.","projects.fullHeading.pre":"Engineering solutions to","projects.fullHeading.accent":"real data","projects.fullHeading.post":"challenges","projects.fullLead":"Eight portfolio projects shown with real pipeline runs, reliability screenshots, test output, CI checkpoints, and repository evidence. Metrics are recorded checkpoints, not a claim that every system is running live.",
  ...
  th: {
    ...
    "projects.eyebrow":"โปรเจกต์เด่น","projects.heading":"โปรเจกต์ที่ทำเสร็จแล้ว","projects.lead":"โปรเจกต์ Data Engineering แบบ production-style พร้อมภาพหลักฐานจริงจาก pipeline, reliability, test, CI และ repository","projects.viewAll":"ดูโปรเจกต์ทั้งหมด","projects.viewProject":"ดูโปรเจกต์","projects.privateRepo":"Private Repo • Verified Evidence","projects.fullHeading":"Engineering solutions to real data challenges.","projects.fullHeading.pre":"Engineering solutions to","projects.fullHeading.accent":"real data","projects.fullHeading.post":"challenges","projects.fullLead":"8 โปรเจกต์ใน Portfolio แสดงภาพจาก pipeline run, reliability lab, test output, CI checkpoint และ repository evidence จริง ตัวเลขคือ checkpoint ที่บันทึกไว้ ไม่ได้หมายความว่าทุกระบบกำลังรัน live อยู่",
...
TRANSLATIONS.en["moon.about.domain"] = "E-commerce / Marketplace / Operational Data";
...
TRANSLATIONS.th["moon.about.domain"] = "E-commerce / Marketplace / Operational Data";
