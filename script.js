...
const TRANSLATIONS = {
  en: {
    ...
    "projects.eyebrow":"FEATURED PROJECTS","projects.heading":"Completed Projects","projects.lead":"Production-style data engineering projects with real-world business context and verified evidence.","projects.viewAll":"View All Projects","projects.viewProject":"View Project","projects.privateRepo":"Private Repo • Verified Evidence","projects.fullHeading":"Engineering solutions to real data challenges.","projects.fullHeading.pre":"Engineering solutions to","projects.fullHeading.accent":"real data","projects.fullHeading.post":"challenges","projects.fullLead":"Seven completed repositories. Each project begins with a real data problem and shows how the system was built, validated, operated, and explained.",
  ...
  th: {
    ...
    "projects.eyebrow":"โปรเจกต์เด่น","projects.heading":"โปรเจกต์ที่ทำเสร็จแล้ว","projects.lead":"โปรเจกต์ Data Engineering แบบ production-style ที่เชื่อมกับบริบทธุรกิจจริงและมีหลักฐานรองรับชัดเจน","projects.viewAll":"ดูโปรเจกต์ทั้งหมด","projects.viewProject":"ดูโปรเจกต์","projects.privateRepo":"Private Repo • Verified Evidence","projects.fullHeading":"Engineering solutions to real data challenges.","projects.fullHeading.pre":"Engineering solutions to","projects.fullHeading.accent":"real data","projects.fullHeading.post":"challenges","projects.fullLead":"มีโปรเจกต์ที่ทำเสร็จแล้ว 7 โปรเจกต์ แต่ละโปรเจกต์เริ่มจากปัญหาข้อมูลจริง และแสดงหลักฐานตั้งแต่การสร้าง การตรวจสอบ การใช้งาน ไปจนถึงการอธิบายระบบอย่างเป็นขั้นตอน",
