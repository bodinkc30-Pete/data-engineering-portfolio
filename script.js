...
const TRANSLATIONS = {
  en: {
    ...
    "projects.eyebrow":"FEATURED PROJECTS","projects.heading":"Completed Projects","projects.lead":"Production-style data engineering projects with real-world business context and verified evidence.","projects.viewAll":"View All Projects","projects.viewProject":"View Project","projects.privateRepo":"Private Repo • Verified Evidence","projects.fullHeading":"Engineering solutions to real data challenges.","projects.fullHeading.pre":"Engineering solutions to","projects.fullHeading.accent":"real data","projects.fullHeading.post":"challenges","projects.fullLead":"Eight completed repositories. Each project begins with a real data problem and shows how the system was built, validated, operated, and explained.",
    ...
    "project.airflow.summary":"Production-oriented e-commerce platform with Airflow orchestration, PostgreSQL, dbt warehouse layers, data quality, monitoring, recovery drills, Docker, and CI.","project.airflow.detail":"A production-oriented e-commerce data platform that ingests eight source contracts into PostgreSQL, orchestrates incremental dbt warehouse transformations in Airflow, and proves data quality, monitoring, alerting, recovery, Docker runtime, and CI evidence through controlled failure drills.",
  ...
  th: {
    ...
    "projects.eyebrow":"โปรเจกต์เด่น","projects.heading":"โปรเจกต์ที่ทำเสร็จแล้ว","projects.lead":"โปรเจกต์ Data Engineering แบบ production-style ที่เชื่อมกับบริบทธุรกิจจริงและมีหลักฐานรองรับชัดเจน","projects.viewAll":"ดูโปรเจกต์ทั้งหมด","projects.viewProject":"ดูโปรเจกต์","projects.privateRepo":"Private Repo • Verified Evidence","projects.fullHeading":"Engineering solutions to real data challenges.","projects.fullHeading.pre":"Engineering solutions to","projects.fullHeading.accent":"real data","projects.fullHeading.post":"challenges","projects.fullLead":"มีโปรเจกต์ที่ทำเสร็จแล้ว 8 โปรเจกต์ แต่ละโปรเจกต์เริ่มจากปัญหาข้อมูลจริง และแสดงหลักฐานตั้งแต่การสร้าง การตรวจสอบ การใช้งาน ไปจนถึงการอธิบายระบบอย่างเป็นขั้นตอน",
    ...
    "project.airflow.summary":"แพลตฟอร์ม e-commerce แบบ production-oriented ที่มี Airflow orchestration, PostgreSQL, dbt warehouse layers, data quality, monitoring, recovery drills, Docker และ CI","project.airflow.detail":"แพลตฟอร์มข้อมูล e-commerce แบบ production-oriented ที่รับข้อมูลตาม source contract 8 กลุ่มเข้า PostgreSQL ควบคุมการแปลงข้อมูลแบบ incremental ด้วย Airflow และ dbt และพิสูจน์ data quality, monitoring, alerting, recovery, Docker runtime และ CI ผ่าน controlled failure drills",
