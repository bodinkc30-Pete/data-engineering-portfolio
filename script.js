...
const TRANSLATIONS = {
  en: {
    ...
    "projects.eyebrow":"FEATURED PROJECTS","projects.heading":"Completed Projects","projects.lead":"Production-style data engineering projects with real-world business context and verified evidence.","projects.viewAll":"View All Projects","projects.viewProject":"View Project","projects.fullHeading":"Engineering solutions to real data challenges.","projects.fullHeading.pre":"Engineering solutions to","projects.fullHeading.accent":"real data","projects.fullHeading.post":"challenges","projects.fullLead":"Five completed repositories. Each project begins with a real data problem and shows how the system was built, validated, operated, and explained.",
    ...
    "project.influencer.summary":"Golden Master, deterministic identity resolution, lineage, PostgreSQL warehouse, and explainable matching.","project.influencer.detail":"A deterministic Master Data and PostgreSQL warehouse project that turns fragmented influencer workbooks into governed identity, campaign, performance, and explainable matching data.",
