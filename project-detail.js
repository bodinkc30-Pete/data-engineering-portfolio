...
const PROJECT_DETAILS = {
  "sql-ecommerce": {
    number: "01", tone: "orange", image: "assets/illustrations/projects/cards/project-01-sql-ecommerce-data-engineering.webp", github: "https://github.com/bodinkc30-Pete/sql-ecommerce-data-engineering", tools: ["SQL", "Python", "SQLite", "Airflow", "Docker", "GitHub Actions"], metrics: [["25", "Tables"], ["20", "Views"], ["57", "Indexes"], ["193", "Tests"]],
  ...
  "databricks-lakehouse": {
    number: "02", tone: "purple", image: "assets/illustrations/projects/cards/project-02-databricks-lakehouse-medallion.webp", github: "https://github.com/bodinkc30-Pete/databricks-lakehouse-medallion-pipeline", tools: ["Databricks", "Apache Spark", "Delta Lake", "PySpark", "CDC", "CI"], metrics: [["7/7", "Reliability Labs"], ["5,249", "Rows"], ["25", "Evidence"], ["PASS", "Public CI"]],
  ...
  "influencer-intelligence": {
    number: "03", tone: "pink", image: "assets/illustrations/projects/cards/project-03-influencer-master-data-intelligence.webp", github: "https://github.com/bodinkc30-Pete/influencer-campaign-intelligence-pipeline", tools: ["Python", "SQL", "PostgreSQL", "Entity Resolution", "Lineage", "Testing"], metrics: [["703", "Master"], ["2,519", "Aliases"], ["6,530", "Core Rows"], ["161", "Tests"]],
  ...
  "marketing-campaign": {
    number: "04", tone: "cyan", image: "assets/illustrations/projects/cards/project-04-marketing-campaign-data-platform.webp", github: "https://github.com/bodinkc30-Pete/marketing-campaign-data-platform", tools: ["SQL", "Python", "SQLite", "Validation", "Privacy", "Analytics"], metrics: [["268", "Records"], ["Rejected", "Routing"], ["SQLite", "Analytics"], ["6", "Outputs"]],
  ...
  "ecommerce-pipeline": {
    number: "05", tone: "mint", image: "assets/illustrations/projects/cards/project-05-ecommerce-data-pipeline.webp", github: "https://github.com/bodinkc30-Pete/ecommerce-data-pipeline", tools: ["Python", "Pandas", "SQLite", "Excel", "Validation", "SQL"], metrics: [["105", "Records"], ["DQ", "Sample PASS"], ["SQLite", "Analytics"], ["5", "Outputs"]],
  ...
  "bigquery-enterprise": {
    number: "06", tone: "blue", image: "assets/illustrations/projects/cards/project-06-bigquery-enterprise-data-platform.webp", github: "https://github.com/bodinkc30-Pete/bigquery-enterprise-data-platform", tools: ["GCS", "BigQuery", "dbt", "Terraform", "IAM", "CI/CD"], metrics: [["32/32", "Definition of Done"], ["12/12", "Runtime Proof"], ["8", "RAW Tables"], ["PASS", "Public CI"]],
  ...
  "airflow-dbt": {
    number: "08", tone: "airflow", image: "assets/illustrations/projects/cards/project-08-airflow-dbt-ecommerce-platform.webp", github: "https://github.com/bodinkc30-Pete/airflow-dbt-ecommerce-data-platform", tools: ["Airflow", "PostgreSQL", "dbt", "Docker", "Monitoring", "CI"], metrics: [["8", "Sources"], ["257", "dbt Pass"], ["37/37", "PostgreSQL Tests"], ["PASS", "Hosted CI"]],
